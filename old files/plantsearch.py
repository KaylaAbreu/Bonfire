...
class PlantSearch(Screen):
    ...
    def capture(self):
        ...
        image_path = "image_{}.png".format(timenow)
        # self.image.export_to_png(image_path)
        ...
        vertical_img = pil_image.transpose(PilImage.FLIP_TOP_BOTTOM)
    ...
    def show_suggestions_popup(self, suggestions_content):
        ...
        # create label for scrollview
        body_label = MDLabel(text=suggestions_content,
                             size_hint_y=None,
                             markup=True,
                             valign="top",
                             padding=(10, 20))
...
class Bonfire(MDApp):
    ...
    def build(self):
        ...
        Builder.load_file("plantsearch.kv")
